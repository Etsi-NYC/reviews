...
for (let k = 0; k < 100; k++) {
  let numReviews = 10 + Math.floor(Math.random() * 100);
  for (let i = 0; i < numReviews; i++) {
    let username = ["Al", "Bob", "Charlie"][i % 3];
    let profile_pic_path = [
      "https://pngimage.net/wp-content/uploads/2018/06/koala-face-png.png",
      ...
      "https://i.pinimg.com/originals/1a/ff/f3/1afff312c4a098869751f43233f25a7f.jpg"
    ][i % 4];
    ...
    let image_path = [
      ...
      "https://www.rods.com/media/catalog/category/mbootsthumb.jpg",
